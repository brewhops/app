...
\begin{itemize}
	...
	\item {Eliminate paper tracking logs with updates that can accessed from any device}
	    \begin{itemize}
			\item {Pipelining physical measurements from tanknet instruments to the database will eliminate brewers need to copy data to the master spreadsheet manually. The web application will allow access to this information.}
		\end{itemize}
\end{itemize}
...
\item {Backend will transfer Tanknet data into database}
