...
\section{Introduction}
	...
	\subsection{Scope}
		...
		Database will store: beer type identifier, batch number, GEN\question{Need clarification from Daniel on what this is}, Dry Hop/Adjunct Type\question{Need clarification from Daniel on what this is}, hop amount, and data on internal brewing vat (IBV) measurements.
		IBV data points include: S.G.\question{Need clarification from Daniel on what this is}, pH level, Alcohol By Volume (ABV), and beer temperature.
