...
\section{Interactive Web Frameworks}
  ...
  \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Angular is really big, but someone that knows Angular 1 does not nesicarily know Angular 2 or 4\footnote{Angular 3 does not exist. They skipped a number}
    \end{itemize}
